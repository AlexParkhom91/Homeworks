...
/*
 Саня, в общем до конца не доделал. Сегодня такой здоровый код написал и удалил все на психах, переписал половину и то криво, изначально все размеры задавал под все устройства, завтра переделаю, но если ты открыл проект с утра, то может ты глянешь своим взглядом и что нибудь поймещь
 Я пока добавил толлько 2 кнопки, нету времени уже на лево и право, можешь доделать, там все про примеру
 а вот функция работает криво, кароче все вылазит за поля, если вверх не вылазит, но не подходит к самому краю
 функции я брал с проекта домашки номер 6, как Боря делал. но почему-то у бори работает, а тут не хочет, хз
 
 открывай проект на айфон 11
